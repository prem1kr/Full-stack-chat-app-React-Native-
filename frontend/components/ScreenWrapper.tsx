import { ImageBackground, Platform, StyleSheet, Text, View, Dimensions, StatusBar } from 'react-native';
...
const ScreenWrapper = ({
  ...
  return (
    <ImageBackground style={{ flex: 1, backgroundColor: isModal ? colors.white : colors.neutral900, }}
      imageStyle={{ opacity: showPattern ? bgOpacity : 0 }} source={require("../assets/images/bgPattern.png")} >
